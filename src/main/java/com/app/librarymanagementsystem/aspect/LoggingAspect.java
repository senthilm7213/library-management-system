package com.app.librarymanagementsystem.aspect;
...
public class LoggingAspect {
    ...
    @Before("execution(* com.app.librarymanagementsystem..*(..))")
    public void logBeforeMethod(JoinPoint joinPoint) {
        log.info("Enter: {}() with argument[s] = {}", joinPoint.getSignature().getName(), joinPoint.getArgs());
    }

    @AfterReturning(pointcut = "execution(* com.app.librarymanagementsystem..*(..))", returning = "result")
    public void logAfterMethod(JoinPoint joinPoint, Object result) {
        log.info("Exit: {}() with result = {}", joinPoint.getSignature().getName(), result);
    }

    @Around("execution(* com.app.librarymanagementsystem..*(..))")
